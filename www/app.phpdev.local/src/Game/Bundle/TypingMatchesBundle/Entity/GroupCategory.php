...
/**
 * @ORM\Entity(repositoryClass="Game\Bundle\TypingMatchesBundle\Entity\Repository\GroupCategoryRepository")
...
class GroupCategory
{
   ...
   *
   * @Gedmo\Translatable
   * @ORM\Column(name="name", type="string", options={"comment":"Group name"})
   */
  protected $name;
   ...
   *
   * @ORM\ManyToOne(targetEntity="Game\Bundle\UserBundle\Entity\User", inversedBy="created_notification_categories")
   ...
   *
   * @ORM\ManyToOne(targetEntity="Game\Bundle\UserBundle\Entity\User", inversedBy="updated_notification_categories")
